...
public class Play_UI extends ListActivity {
    ...
    private void fill(File f)
    {
    	File[]dirs = f.listFiles(); 
		 ...
		 adapter = new FileArrayAdapter(Play_UI.this,R.layout.file_view,dir);
    ...
    private void onFileClick(Item o)
    {
    	...
    	Intent intent = new Intent(Play_UI.this, Play_Process.class);
