...
public class AnimatedView extends ImageView{
	 ...
	 *   FILEIOHELPER.ARRAY_BUFFER_SIZE. Fire a thread to do this, use the launchThread stub. 
	...
	private class DataWindow {
		...
		public DataWindow(Context context, int windowSize) {
			...
			if(m_esHelper.makeReadFile()) {
				...
				// Initialize arrayScene by reading the first FileIOHelper.ARRAY_BUFFER_SIZE # of elements
