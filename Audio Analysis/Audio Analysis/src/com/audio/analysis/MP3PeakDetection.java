...
import com.audio.io.MP3Decoder;
...
public class MP3PeakDetection 
{
	...
	{
		MP3Decoder decoder = new MP3Decoder( new FileInputStream( FILE  ) );	// setup the audio file to be read using the MP3Decoder class							
        ...
        // Displays the detected peaks
        Plot plot = new Plot( "Peaks", 1024, 512 );
		plot.plot( peaks, 1, Color.red );
		
		// Plays the song with a moving vertical bar which shows the song position 
