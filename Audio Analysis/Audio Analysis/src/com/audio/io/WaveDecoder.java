 ...
 *
 */
public class WaveDecoder implements com.audio.io.Decoder
{
        ...
        {
                WaveDecoder decoder = new WaveDecoder( new FileInputStream( "C:/Users/hp/Music/Brittany's Music Library/New Folder (2)/Ihatethispart.wav" ) );
